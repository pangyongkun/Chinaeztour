...
$cat=get_term_by('name',$current_category,'blog_category');
                        ...
                        while ($query->have_posts()):
                            ...
                            <div class="post-modern-timeline-date text-sm-left">
                                <div class="reveal-inline-block text-center">
                                    <time datetime="2016-01-01" class="text-regular text-darker"><?php echo get_the_time('Y-m-d') ?> <br class="veil reveal-md-inline-block"> at <?php echo get_the_time('G:i:s') ?></time>
                                </div>
                            </div>
                            ...
                            <article class="post post-modern post-modern-timeline post-modern-timeline-left">
                                ...
                                <section class="post-content text-left">
                                    <div class="post-modern-classic-meta"><a href="#"><span class="icon text-middle icon icon-xxs icon-extra-small mdi fa-camera text-orange-peel"></span><span class="text-middle text-darker text-bold">Photos</span></a></div>
                                    <!-- Post Title-->
                            ...
                            <div class="blog-grid-sidebar inset-xl-left-80">
                                ...
                                <aside class="text-left">
                                    ...
                                    <div class="offset-top-13 offset-md-top-20 rd-search-blog">
                                        <form id="searchform" action="<?php bloginfo('home'); ?>/blog-search" method="post" class="form-search rd-search">
                                            <div class="form-group">
                                                <label for="blog-classic-form-search-widget" class="form-label form-search-label rd-input-label"></label>
                                                <input type="text" id="blog-classic-form-search-widget" name="blog-key" autocomplete="off" class="form-search-input form-control null">
                                            </div>
                                            <button type="submit" class="form-search-submit" id="searchsubmit"><span class="fa fa-search"></span></button>
                                        </form>
                                    </div>
