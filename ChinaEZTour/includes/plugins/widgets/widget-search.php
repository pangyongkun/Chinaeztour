...
class bookyourtravel_search_widget extends WP_Widget
{
        ...
        if ($searchable_count > 0) {
            ...
            <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">
                <form class="widget-search" method="get"
                      action="<?php echo esc_url($this->custom_search_results_page); ?>">
                    ...
                    <div>
                        ...
                        $this->render_start_city();

                        //$this->render_duration_day();
                    ...
                    <input type="submit" value="<?php echo esc_attr($submit_button_text); ?>" class="gradient-button"
                           id="search-submit"/>
                </form>
            </article>
        <?php
    ...
    function render_where_section($where_text, $location_select_label_text)
    {
        ...
        if (isset($_GET['l'])) {
            $request_type_ids = BookYourTravel_Theme_Utils::retrieve_array_of_values_from_query_string('l', true);
        }
    ...
    if (count($location_results) > 0 && $location_results['total'] > 0)
    {
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                $('#ct2').bind('click', function () {
                    if (!$('#ct1').is(':checked') && $(this).is(':checked')) {
                        $('#when').css('display', 'none');
                        $('#search_widget_date_from').val('');
                    } else {
                        $('#when').css('display', '');
                    }

                });
                $('#ct1').bind('click', function () {
                    if (!$(this).is(':checked') && $('#ct2').is(':checked')) {
                        $('#when').css('display', 'none');
                        return;
                    }
                    $('#when').css('display', '');
                });
                /*$('.search_tour_wrap').mouseover(function () {
                 $(this).css('overflow-y', 'scroll');
                 }).mouseout(function(){
                 $(this).css('overflow-y', 'hidden');
                 });*/
                $(".go-through-city").select2({
                    placeholder: 'Go Through Cities',
                    ajax: {
        ...
        <div class="tour_search">
            <div class="search_tour_wrap">
                <select name="l[]" class="go-through-city js-states booking_form_controls" id="id_label_go_thought_cities"
                        multiple="multiple">
                </select>
                <?php
                echo '</div></div>';
                ...
                <div class="column">
                    <div class="where dd">
                        ...
                        <div class="destination">
                            <label for="search_widget_term">Search Start City</label>
                        </div>
                    </div>
                </div>

                <?php
                if (isset($_GET['start_city'])) {
                    $request_type_ids = BookYourTravel_Theme_Utils::retrieve_array_of_values_from_query_string('start_city', true);
                }
                ?>
                    <div class="tour_search">
                        <div class="search_tour_wrap">
                            <select class="start-city js-states booking_form_controls" id="id_label_start_city"
                                    name="start_city[]">
                ...
                <div class="column">
                    <div class="where dd">
                        <div class="destination">
                            <label for="search_widget_term">Duration Day</label>
                        </div>
                    </div>
                </div>
                ...
                //$l = isset($_GET['l']) ? intval(wp_kses($_GET['l'], array())) : 0;
                if (isset($_GET['day'])) {
                    $request_type_ids = BookYourTravel_Theme_Utils::retrieve_array_of_values_from_query_string('day', true);
                }
                ...
                ?>
                    <div class="tour_search">
                        <div class="search_tour_wrap">
                            <select class="duration-day js-states form-control" id="id_label_start_city"
                                    name="duration_day">
                                <option value="0">duration day</option>
                                <option value="1">1 day</option>
                                <option value="2">2-5 days</option>
                                <option value="3">6-10 days</option>
                                <option value="4">11-15 days</option>
                                <option value="5">16-20 days</option>
                ...
                function render_room_count_section($rooms_label_text)
                {
                    ...
                    <div class="column">
                        ...
                        <div class="rooms dd">
                            <div class="spinner">
                                <input type="text" id="search_widget_rooms" name="rooms"
                ...
                <?php
                        ...
                        function render_cabin_count_section($cabins_label_text)
                        {
                            ...
                            <div class="column">
                                ...
                                <div class="cabins dd">
                                    <div class="spinner">
                                        <input type="text" id="search_widget_cabins" name="cabins"
                                               value="<?php echo esc_attr($cabins); ?>"/>
                                    </div>
                                </div>
                            </div>
                        <?php
                ...
                <div class="column" id="when">
                    ...
                    <div class="when dd">
                        ...
                        <div class="datepicker">
                            <label
                                for="search_widget_date_from"><?php echo $accommodation_date_from_label_text; ?></label>

                            <div class="datepicker-wrap"><input type="text" id="search_widget_date_from"
                                                                placeholder=""/></div>
                            <input type="hidden" id="from" name="from"/>
                        </div>
                        <div class="datepicker">
                            <label
                                for="search_widget_date_to"><?php echo $accommodation_date_to_label_text; ?></label>

                            <div class="datepicker-wrap"><input type="text" id="search_widget_date_to"
                                                                placeholder=""/></div>
            ...
            <?php
                                        ...
                                        if (isset($cruise_types[$i])) {
                                            ...
                                            <div class="checkbox">
                                                <input <?php echo $checked; ?>
                                                    value="<?php echo esc_attr($cruise_type->term_id); ?>"
                                                    type="checkbox" id="at<?php echo $i + 1; ?>" name="cruise_types[]"/>
                                                <label
                                                    for="at<?php echo $i + 1; ?>"><?php echo esc_attr($cruise_type->name); ?></label>
                                            </div>
                                        <?php } ?>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="accommodation_type dd">
                                    <?php for ($i = 0; $i < count($accommodation_types); $i++) {
                                        ...
                                        if (isset($accommodation_types[$i])) {
                                            ...
                                            <div class="checkbox">
                                                <input <?php echo $checked; ?>
                                                    value="<?php echo esc_attr($accommodation_type->term_id); ?>"
                                                    type="checkbox" id="at<?php echo $i + 1; ?>"
                                                    name="accommodation_types[]"/>
                                                <label
                                                    for="at<?php echo $i + 1; ?>"><?php echo esc_attr($accommodation_type->name); ?></label>
                                            </div>
                                        <?php } ?>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="car_type dd">
                                    <?php for ($i = 0; $i < count($car_types); $i++) {
                                        if (isset($car_types[$i])) {
                                            ...
                                            <div class="checkbox">
                                                <input <?php echo $checked; ?>
                                                    value="<?php echo esc_attr($car_type->term_id); ?>" type="checkbox"
                                                    id="ct<?php echo $i + 1; ?>" name="car_types[]"/>
                                                <label
                                                    for="ct<?php echo $i + 1; ?>"><?php echo esc_attr($car_type->name); ?></label>
                                            </div>
                                        <?php }
                                    } ?>
                                </div>
                                ...
                                <div class="tour_type dd " >
                                    <?php for ($i = 0; $i < count($tour_types); $i++) {
                                        if (isset($tour_types[$i])) {
                                            ...
                                            <div class="checkbox">
                                                <input <?php echo $checked; ?>
                                                    value="<?php echo esc_attr($tour_type->term_id); ?>" type="checkbox"
                                                    id="ct<?php echo $i + 1; ?>" name="tour_types[]"/>
                                                <label
                                                    for="ct<?php echo $i + 1; ?>"><?php echo esc_attr($tour_type->name); ?></label>
                                            </div>
                                        <?php }
                                    } ?>
                                </div>
                    ...
                    function render_user_rating_section($user_rating_label_text)
                    {
                        ...
                        <div class="column">
                            ...
                            <div class="user_rating dd">
                                ...
                                <input type="hidden" id="search_widget_rating" name="rating"
                    ...
                    function render_star_rating_section($star_rating_label_text)
                    {
                        ...
                        <div class="column">
                            ...
                            <div class="star_rating dd">
                                ...
                                <span
                                    class="stars-info"><?php echo sprintf(esc_html__('%d or more', 'bookyourtravel'), $stars); ?></span>
                                    ...
                                    for ($i = 0; $i < $price_range_count; $i++) {
                                        ...
                                        <div class="checkbox">
                                            <input <?php echo $checked; ?> type="checkbox"
                                                                           id="price<?php echo esc_attr($price_index); ?>"
                                                                           name="price[]"
                                                                           value="<?php echo esc_attr($price_index); ?>"/>
                        ...
                        if ($searchable_count > 1) { ?>
                            <div class="column">
                                ...
                                <div class="what dd">
                                    ...
                                    <?php } ?>
                                        <div
                                            class="checkbox <?php echo $this->is_accommodation_what_active($what) ? 'active' : ''; ?>">
                                            <input type="radio" name="what" id="accommodation"
                                                   value="1" <?php echo $this->is_accommodation_what_active($what) ? ' checked="checked"' : ''; ?> />
                                            <label
                                                for="accommodation"> <?php esc_html_e('Accommodation', 'bookyourtravel'); ?></label>
                                        </div>
                                    <?php }
                                    if ($this->enable_car_rentals && $this->make_car_rentals_searchable) {
                                    ...
                                    <?php } ?>
                                        <div
                                            class="checkbox <?php echo $this->is_car_rental_what_active($what) ? 'active' : '' ?>">
                                            <input type="radio" name="what" id="car_rental"
                                                   value="2" <?php echo $this->is_car_rental_what_active($what) ? ' checked="checked" ' : '' ?> />
                                            <label
                                                for="car_rental"> <?php esc_html_e('Rent a Car', 'bookyourtravel'); ?></label>
                                        </div>
                                    <?php }
                                    if ($this->enable_tours && $this->make_tours_searchable) {
                                    ...
                                    <?php } ?>
                                        <div
                                            class="checkbox <?php echo $this->is_tour_what_active($what) ? 'active' : '' ?>">
                                            <input type="radio" name="what" id="tour"
                                                   value="3" <?php echo $this->is_tour_what_active($what) ? ' checked="checked" ' : '' ?> />
                                    ...
                                    <?php } ?>
                                        <div
                                            class="checkbox <?php echo $this->is_cruise_what_active($what) ? 'active' : '' ?>">
                                            <input type="radio" name="what" id="cruise"
                                                   value="4" <?php echo $this->is_cruise_what_active($what) ? ' checked="checked"' : '' ?> />
                                            <label
                                                for="cruise"> <?php esc_html_e('Cruise', 'bookyourtravel'); ?></label>
                                        </div>
                                    <?php
                                    } ?>
                                </div>
                    ...
                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'bookyourtravel') ?></label>
                    ...
                    <p>
                        <input id="<?php echo esc_attr($this->get_field_id('show_what_filter')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('show_what_filter')); ?>" type="checkbox"
                               value="1" <?php checked($instance['show_what_filter']); ?> />
                        <label
                            for="<?php echo esc_attr($this->get_field_id('show_what_filter')); ?>"><?php esc_html_e('Show "What" filter?', 'bookyourtravel'); ?></label>
                    </p>

                    <p>
                        <input id="<?php echo esc_attr($this->get_field_id('show_where_filter')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('show_where_filter')); ?>"
                               type="checkbox" value="1" <?php checked($instance['show_where_filter']); ?> />
                        <label
                            for="<?php echo esc_attr($this->get_field_id('show_where_filter')); ?>"><?php esc_html_e('Show "Where" filter?', 'bookyourtravel'); ?></label>
                    </p>

                    <p style="<?php echo $bookyourtravel_theme_globals->search_only_available_properties() ? 'display:block;' : 'display:none'; ?>">
                        <input id="<?php echo esc_attr($this->get_field_id('show_when_filter')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('show_when_filter')); ?>" type="checkbox"
                               value="1" <?php checked($instance['show_when_filter']); ?> />
                        <label
                            for="<?php echo esc_attr($this->get_field_id('show_when_filter')); ?>"><?php esc_html_e('Show "When" filter?', 'bookyourtravel'); ?></label>
                    </p>

                    <p>
                        <input id="<?php echo esc_attr($this->get_field_id('show_price_filter')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('show_price_filter')); ?>"
                               type="checkbox" value="1" <?php checked($instance['show_price_filter']); ?> />
                        <label
                            for="<?php echo esc_attr($this->get_field_id('show_price_filter')); ?>"><?php esc_html_e('Show "Price" filter?', 'bookyourtravel'); ?></label>
                    </p>

                    <?php if ($this->enable_reviews) { ?>
                        <p>
                            <input id="<?php echo esc_attr($this->get_field_id('show_rating_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_rating_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_rating_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_rating_filter')); ?>"><?php esc_html_e('Show "Rating" filter?', 'bookyourtravel'); ?></label>
                        </p>
                    <?php } ?>
                    ...
                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('what_text')); ?>"><?php esc_html_e('What label:', 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('what_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('what_text')); ?>"
                               value="<?php echo esc_attr($instance['what_text']); ?>"/>
                    </p>

                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('when_text')); ?>"><?php esc_html_e('When label:', 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('when_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('when_text')); ?>"
                               value="<?php echo esc_attr($instance['when_text']); ?>"/>
                    </p>

                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('where_text')); ?>"><?php esc_html_e('Where label:', 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('where_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('where_text')); ?>"
                               value="<?php echo esc_attr($instance['where_text']); ?>"/>
                    </p>

                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('location_select_label_text')); ?>"><?php esc_html_e('Location label:', 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('location_select_label_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('location_select_label_text')); ?>"
                               value="<?php echo esc_attr($instance['location_select_label_text']); ?>"/>
                    </p>

                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('price_per_person_label_text')); ?>"><?php esc_html_e("Price per person label", 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('price_per_person_label_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('price_per_person_label_text')); ?>"
                               value="<?php echo esc_attr($instance['price_per_person_label_text']); ?>"/>
                    </p>

                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('price_per_night_label_text')); ?>"><?php esc_html_e("Price per night label", 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('price_per_night_label_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('price_per_night_label_text')); ?>"
                               value="<?php echo esc_attr($instance['price_per_night_label_text']); ?>"/>
                    </p>

                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('price_per_day_label_text')); ?>"><?php esc_html_e("Price per day label", 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('price_per_day_label_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('price_per_day_label_text')); ?>"
                               value="<?php echo esc_attr($instance['price_per_day_label_text']); ?>"/>
                    </p>

                    <?php if ($this->enable_reviews) { ?>
                        <p>
                            <label
                                for="<?php echo esc_attr($this->get_field_id('user_rating_label_text')); ?>"><?php esc_html_e("User rating label", 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('user_rating_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('user_rating_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['user_rating_label_text']); ?>"/>
                        </p>
                    <?php } ?>
                    ...
                    <?php if ($this->enable_accommodations) { ?>
                        ...
                        <p>
                            <input id="<?php echo esc_attr($this->get_field_id('make_accommodations_searchable')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('make_accommodations_searchable')); ?>"
                                   type="checkbox"
                                   value="1" <?php checked($instance['make_accommodations_searchable']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('make_accommodations_searchable')); ?>"><?php esc_html_e('Make accommodations searchable?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <input id="<?php echo esc_attr($this->get_field_id('show_accommodation_type_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_accommodation_type_filter')); ?>"
                                   type="checkbox"
                                   value="1" <?php checked($instance['show_accommodation_type_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_accommodation_type_filter')); ?>"><?php esc_html_e('Show "Accommodation type" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <input id="<?php echo esc_attr($this->get_field_id('show_stars_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_stars_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_stars_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_stars_filter')); ?>"><?php esc_html_e('Show "Stars" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p>
                            <input id="<?php echo esc_attr($this->get_field_id('show_room_count_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_room_count_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_room_count_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_room_count_filter')); ?>"><?php esc_html_e('Show "Rooms" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('accommodation_date_from_label_text')); ?>"><?php esc_html_e('Accommodation date from label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('accommodation_date_from_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('accommodation_date_from_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['accommodation_date_from_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('accommodation_date_to_label_text')); ?>"><?php esc_html_e('Accommodation date to label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('accommodation_date_to_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('accommodation_date_to_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['accommodation_date_to_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('accommodation_location_label_text')); ?>"><?php esc_html_e('Accommodation location label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('accommodation_location_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('accommodation_location_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['accommodation_location_label_text']); ?>"/>
                        </p>

                        <p>
                            <label
                                for="<?php echo esc_attr($this->get_field_id('rooms_label_text')); ?>"><?php esc_html_e('Rooms label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('rooms_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('rooms_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['rooms_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('accommodation_type_label_text')); ?>"><?php esc_html_e("Accommodation type label", 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('accommodation_type_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('accommodation_type_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['accommodation_type_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $accommodation_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('star_rating_label_text')); ?>"><?php esc_html_e("Star rating label", 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('star_rating_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('star_rating_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['star_rating_label_text']); ?>"/>
                        </p>
                    ...
                    <?php if ($this->enable_tours) { ?>
                        ...
                        <p>
                            <input id="<?php echo esc_attr($this->get_field_id('make_tours_searchable')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('make_tours_searchable')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['make_tours_searchable']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('make_tours_searchable')); ?>"><?php esc_html_e('Make tours searchable?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $tour_fields_visible ? '' : 'display:none'; ?>">
                            <input id="<?php echo esc_attr($this->get_field_id('show_tour_type_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_tour_type_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_tour_type_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_tour_type_filter')); ?>"><?php esc_html_e('Show "Tour type" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $tour_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('tour_date_from_label_text')); ?>"><?php esc_html_e('Tour date from label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('tour_date_from_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('tour_date_from_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['tour_date_from_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $tour_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('tour_type_label_text')); ?>"><?php esc_html_e("Tour type label", 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('tour_type_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('tour_type_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['tour_type_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $tour_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('tour_location_label_text')); ?>"><?php esc_html_e('Tour location label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('tour_location_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('tour_location_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['tour_location_label_text']); ?>"/>
                        </p>
                    ...
                    <?php if ($this->enable_car_rentals) { ?>
                        ...
                        <p>
                            <input id="<?php echo esc_attr($this->get_field_id('make_car_rentals_searchable')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('make_car_rentals_searchable')); ?>"
                                   type="checkbox"
                                   value="1" <?php checked($instance['make_car_rentals_searchable']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('make_car_rentals_searchable')); ?>"><?php esc_html_e('Make car rentals searchable?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $car_rental_fields_visible ? '' : 'display:none'; ?>">
                            <input id="<?php echo esc_attr($this->get_field_id('show_car_type_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_car_type_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_car_type_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_car_type_filter')); ?>"><?php esc_html_e('Show "Car type" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $car_rental_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('car_rental_date_from_label_text')); ?>"><?php esc_html_e('Car rental date from label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('car_rental_date_from_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('car_rental_date_from_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['car_rental_date_from_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $car_rental_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('car_rental_date_to_label_text')); ?>"><?php esc_html_e('Car rental date to label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('car_rental_date_to_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('car_rental_date_to_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['car_rental_date_to_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $car_rental_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('car_rental_location_label_text')); ?>"><?php esc_html_e('Car rental location label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('car_rental_location_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('car_rental_location_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['car_rental_location_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $car_rental_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('car_type_label_text')); ?>"><?php esc_html_e("Car type label", 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('car_type_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('car_type_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['car_type_label_text']); ?>"/>
                        </p>
                    ...
                    <?php if ($this->enable_cruises) { ?>
                        ...
                        <p>
                            <input id="<?php echo esc_attr($this->get_field_id('make_cruises_searchable')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('make_cruises_searchable')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['make_cruises_searchable']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('make_cruises_searchable')); ?>"><?php esc_html_e('Make cruises searchable?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $cruise_fields_visible ? '' : 'display:none'; ?>">
                            <input id="<?php echo esc_attr($this->get_field_id('show_cruise_type_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_cruise_type_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_cruise_type_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_cruise_type_filter')); ?>"><?php esc_html_e('Show "Cruise type" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $cruise_fields_visible ? '' : 'display:none'; ?>">
                            <input id="<?php echo esc_attr($this->get_field_id('show_cabin_count_filter')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('show_cabin_count_filter')); ?>"
                                   type="checkbox" value="1" <?php checked($instance['show_cabin_count_filter']); ?> />
                            <label
                                for="<?php echo esc_attr($this->get_field_id('show_cabin_count_filter')); ?>"><?php esc_html_e('Show "Cabin count" filter?', 'bookyourtravel'); ?></label>
                        </p>

                        <p style="<?php echo $cruise_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('cruise_date_from_label_text')); ?>"><?php esc_html_e('Cruise date from label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('cruise_date_from_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('cruise_date_from_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['cruise_date_from_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $cruise_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('cabins_label_text')); ?>"><?php esc_html_e('Cabins label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('cabins_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('cabins_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['cabins_label_text']); ?>"/>
                        </p>

                        <p style="<?php echo $cruise_fields_visible ? '' : 'display:none'; ?>">
                            <label
                                for="<?php echo esc_attr($this->get_field_id('cruise_type_label_text')); ?>"><?php esc_html_e('Cruise type label:', 'bookyourtravel') ?></label>
                            <input type="text" class="widefat"
                                   id="<?php echo esc_attr($this->get_field_id('cruise_type_label_text')); ?>"
                                   name="<?php echo esc_attr($this->get_field_name('cruise_type_label_text')); ?>"
                                   value="<?php echo esc_attr($instance['cruise_type_label_text']); ?>"/>
                        </p>
                    ...
                    <p>
                        <label
                            for="<?php echo esc_attr($this->get_field_id('submit_button_text')); ?>"><?php esc_html_e('Search submit button text', 'bookyourtravel') ?></label>
                        <input type="text" class="widefat"
                               id="<?php echo esc_attr($this->get_field_id('submit_button_text')); ?>"
                               name="<?php echo esc_attr($this->get_field_name('submit_button_text')); ?>"
                               value="<?php echo esc_attr($instance['submit_button_text']); ?>"/>
                    </p>
