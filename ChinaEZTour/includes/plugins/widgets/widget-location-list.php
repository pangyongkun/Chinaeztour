...
/*-----------------------------------------------------------------------------------*/
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', isset($instance['title']) ? $instance['title'] : esc_html__('Destinations', 'bookyourtravel') );
		
		$number_of_posts = isset($instance['number_of_posts']) ? (int)$instance['number_of_posts'] : 8;
		$sort_by = isset($instance['sort_by']) ? $instance['sort_by'] : 'modified';
		$sort_descending = isset($instance['sort_by']) && $instance['sort_descending'] == '1';
		$order = $sort_descending ? 'ASC' : 'DESC';
...
/*		$show_featured_only = isset($instance['show_featured_only']) && $instance['show_featured_only'] == '1';*/
		...
		?><!--deals--><div id="destinations" class="destinations"><?php
		} else {
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/beijing" title="Beijing">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/beijing.jpg" alt="Beijing" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/beijing' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Beijing</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/shanghai" title="Shanghai">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/pudongyejing.jpg" alt="Shanghai" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/shanghai' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Shanghai</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/guangxi/guilin" title="Guilin">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/34a2ee113eefd833d5dd661a881748a0.XL_-1024x576.jpg" alt="Guilin" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/guangxi/guilin' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Guilin</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/shaanxi/xian" title="Xi&#039;an">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/328061-14012F1140918.jpg" alt="Xi&#039;an" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/shaanxi/xian' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Xi'an</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/luoyang" title="Luoyang">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/timg-30.jpg" alt="Luoyang" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/luoyang' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Luoyang</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/hubei-2/harbin" title="Harbin">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/u90482387_1370e58020fg214.jpg" alt="Harbin" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/hubei-2/harbin' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Harbin</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/jiangsu/nanjing" title="Nanjing">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/1546222621_0.jpg" alt="Nanjing" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/jiangsu/nanjing' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Nanjing</h4>
							</div>
		</div>
	</article>
	...
	<article class="location_item one-fourth">
		<div>
			<figure>
				<a href="http://www.chinaeztour.com/guide/huangshan" title="Huangshan">
					<img class="lazy"  data-original="http://www.chinaeztour.com/wp-content/uploads/yks.jpg" alt="Huangshan" />
				</a>
			</figure>
			<div class="details">
				<div class='actions'><a href='http://www.chinaeztour.com/guide/huangshan' class='gradient-button'  title='View all'>View all</a></div>				
				<h4>Huangshan</h4>
							</div>
		</div>
	</article>
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Destination', 'bookyourtravel'),
			'number_of_posts' => '4',
			'sort_by' => 'title',
			'sort_descending' => '1',
			'display_mode' => 'card',
