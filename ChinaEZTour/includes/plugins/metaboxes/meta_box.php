...
function custom_meta_box_field( $field, $meta = null, $repeatable = null ) {
	...
	switch( $type ) {
        ...
        case 'location_checkboxes':
            $posts = get_posts( array( 'post_type' => $post_type,'orderby'=> 'post_name','meta_key'=> 'location_province_city', 'meta_value'=>'city','order'=>'ASC', 'posts_per_page' => -1, 'suppress_filters' => 0 ) );
            echo '<ul >';
            foreach ( $posts as $item )
