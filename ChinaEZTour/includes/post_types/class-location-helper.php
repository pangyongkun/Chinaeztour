...
/*			array( // Post ID select box
                ...
                'desc'	=> esc_html__('Check this option if you want to show list of descendant locations when showing this single location instead of showing what single location page usually shows. Useful for Provinces locations that than lists all of that Province\'s cities.', 'bookyourtravel'), // description
