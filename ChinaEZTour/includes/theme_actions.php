...
class BookYourTravel_Theme_Actions extends BookYourTravel_BaseSingleton {
	...
	function get_google_fonts_css_uri() {
		...
		* into your own language.
		*/		
		$open_sans = esc_html__( 'off', 'bookyourtravel' );
	...
	function enqueue_scripts_styles() {
		...
		if (!empty($google_fonts_css_uri)) {
			wp_enqueue_style( 'chinaeztour-font-css-style', $google_fonts_css_uri);
		}

		$google_fonts_icon_uri = $this->get_google_fonts_icon_uri();
		if (!empty($google_fonts_icon_uri)) {
			wp_enqueue_style( 'chinaeztour-font-icon-style', $google_fonts_icon_uri);
		}
		
		wp_enqueue_style( 'chinaeztour-font-awesome', BookYourTravel_Theme_Utils::get_file_uri('/css/font-awesome.min.css'), '1.0', "screen,print");
		
		if ($bookyourtravel_theme_globals->enable_rtl() || (defined('BYT_DEMO') && isset($_REQUEST['rtl']))) {
			wp_enqueue_style( 'chinaeztour-style-rtl', BookYourTravel_Theme_Utils::get_file_uri('/css/style-rtl.css'), array('chinaeztour-font-css-style', 'chinaeztour-font-awesome'), '1.0', "screen,print");
		} else {
			wp_enqueue_style( 'chinaeztour-style-main', BookYourTravel_Theme_Utils::get_file_uri('/css/style.css'), array('chinaeztour-font-css-style', 'chinaeztour-font-awesome'), '1.0', "screen,print");
		}

		$color_scheme_style_sheet = $bookyourtravel_theme_globals->get_color_scheme_style_sheet();
		if (!empty($color_scheme_style_sheet)) {
			wp_enqueue_style('chinaeztour-style-color',  BookYourTravel_Theme_Utils::get_file_uri('/css/' . $color_scheme_style_sheet . '.css'), array(), '1.0', "screen,print");
		}

		wp_enqueue_style( 'chinaeztour-style', get_stylesheet_uri() );
		
		wp_enqueue_style('chinaeztour-style-pp',  BookYourTravel_Theme_Utils::get_file_uri('/css/prettyPhoto.css'), array(), '1.0', "screen");		 
	}
	...
	function enqueue_admin_scripts_styles() {
		...
		if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'theme_accommodation_booking_admin.php') {
			wp_register_script('chinaeztour-accommodations-bookings-admin', BookYourTravel_Theme_Utils::get_file_uri('/includes/admin/accommodation_bookings.js'), array('jquery'), '1.0.0');
			wp_enqueue_script('chinaeztour-accommodations-bookings-admin');
		} else if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'theme_accommodation_vacancy_admin.php') {
			wp_register_script('chinaeztour-accommodations-vacancies-admin', BookYourTravel_Theme_Utils::get_file_uri('/includes/admin/accommodation_vacancies.js'), array('jquery'), '1.0.0');
			wp_enqueue_script('chinaeztour-accommodations-vacancies-admin');		
		} else if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'theme_tour_schedule_booking_admin.php') {
			wp_register_script('chinaeztour-tours-bookings-admin', BookYourTravel_Theme_Utils::get_file_uri('/includes/admin/tour_bookings.js'), array('jquery'), '1.0.0');
			wp_enqueue_script('chinaeztour-tours-bookings-admin');		
		} else if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'theme_cruise_schedule_booking_admin.php') {
			wp_register_script('chinaeztour-cruises-bookings-admin', BookYourTravel_Theme_Utils::get_file_uri('/includes/admin/cruise_bookings.js'), array('jquery'), '1.0.0');
			wp_enqueue_script('chinaeztour-cruises-bookings-admin');		
		} else if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'theme_car_rental_booking_admin.php') {
			wp_register_script('chinaeztour-car_rental-bookings-admin', BookYourTravel_Theme_Utils::get_file_uri('/includes/admin/car_rental_bookings.js'), array('jquery'), '1.0.0');
			wp_enqueue_script('chinaeztour-car_rental-bookings-admin');		
		} 

		wp_register_script('chinaeztour-admin', BookYourTravel_Theme_Utils::get_file_uri('/includes/admin/admin.js'), array('jquery'), '1.0.0');
		wp_enqueue_script('chinaeztour-admin');		
		
		wp_enqueue_style('chinaeztour-admin-ui-css', BookYourTravel_Theme_Utils::get_file_uri('/css/jquery-ui.min.css'), false);
		wp_enqueue_style('chinaeztour-admin-css', BookYourTravel_Theme_Utils::get_file_uri('/css/admin-custom.css'), false);
	}
