...
class BookYourTravel_Theme_Globals extends BookYourTravel_BaseSingleton {
    ...
    public function get_facebook(){
        return of_get_option('facebook');
    }
    public function get_twitter(){
        return of_get_option('twitter');
    }
    public function get_google(){
        return of_get_option('google');
    }
    public function get_linkedin(){
        return of_get_option('linkedin');
    }
    public function get_about(){
        return of_get_option('about');
    }
    public  function get_about_us(){
        return of_get_option('about_us');
    }
    /*****************************/
