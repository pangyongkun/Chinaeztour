...
?>
    ...
    <meta name='B-verify' content='2216fa8c3ca31ae3dc95471f223695c7a0e127e5' />
</head>
...
">
    <div class="wrap">
						<div class="row top-row">
							<div class="one-half hidden-xs">
								<div class="left">
									<span class="contact-email small"><?php echo $bookyourtravel_theme_globals::get_contact_email();  ?></span>
									<span class="contact-phone small"><?php echo $bookyourtravel_theme_globals::get_contact_phone_number();  ?></span>
							...
							<div class="one-half">
								<div class="right right-part">
									<span class="top-link small"><a href="/contact-us">Contact us</a></span>
									<span class="top-link small"><a href="/about"><?php echo $bookyourtravel_theme_globals::get_about();  ?></a></span>
                                    <?php 
		...
		<div class="wrap"  style="height:96px">
			<!--logo-->
	...
	if(is_home()||is_front_page()){
		 echo "<div id='slider-overlay'></div>";
	}else{
