...
?>
	...
	<section class="three-fourth">
		...
		<script>	
			...
			window.carRentalIsReservationOnly = <?php echo $car_rental_is_reservation_only; ?>;
		...
		<section id="description" class="tab-content <?php echo $first_display_tab == 'description' ? 'initial' : ''; ?>">
			<article>
				...
				<?php BookYourTravel_Theme_Utils::render_tab_extra_fields('car_rental_extra_fields', $car_rental_extra_fields, 'description', $car_rental_obj, ''); ?>
				</div>
			</article>
		</section>
		<!--//description-->
