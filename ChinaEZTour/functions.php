...
if ( ! defined( 'BOOKYOURTRAVEL_VERSION' ) )
    ...
    define( 'BOOKYOURTRAVEL_VERSION', '7.14' );
...
require_once BookYourTravel_Theme_Utils::get_file_path('/includes/plugins/widgets/widget-my-search.php');
...
require_once BookYourTravel_Theme_Utils::get_file_path('/includes/post_types/class_style_helper.php');



/*修改添加*/

include('custom/add_custom_metabox.php');

include('custom/add_location_of_post.php');

include('custom/custom_rewrite.php');

include('custom/add_frontend_blog.php');

include('custom/add_locatoin_of_blog.php');

include('custom/add_rest_api.php');
