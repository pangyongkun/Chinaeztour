...
/*about us*/
    $options[] = array(
        'name' => esc_html__('About Us', 'bookyourtravel'),
        'desc' => esc_html__('describe your website'),
        'id' => 'about_us',
        'type' => 'textarea');
    ...
    /***************************/
    $options[] = array(
        'name' => esc_html__('Facebook', 'bookyourtravel'),
        'desc' => esc_html__('Your facebook url', 'bookyourtravel'),
        'id' => 'facebook',
        'std' => 'facebook',
        'type' => 'text');
    $options[] = array(
        'name' => esc_html__('Twitter', 'bookyourtravel'),
        'desc' => esc_html__('Your twitter url', 'bookyourtravel'),
        'id' => 'twitter',
        'std' => 'twitter',
        'type' => 'text');
    $options[] = array(
        'name' => esc_html__('Google', 'bookyourtravel'),
        'desc' => esc_html__('Your google url', 'bookyourtravel'),
        'id' => 'google',
        'std' => 'google',
        'type' => 'text');
    $options[] = array(
        'name' => esc_html__('Linkedin', 'bookyourtravel'),
        'desc' => esc_html__('Your linkedin url', 'bookyourtravel'),
        'id' => 'linkedin',
        'std' => 'linkedin',
        'type' => 'text');
    $options[] = array(
        'name' => esc_html__('About', 'bookyourtravel'),
        'desc' => esc_html__('About company', 'bookyourtravel'),
        'id' => 'about',
        'std' => 'about',
        'type' => 'text');
    /***************************/
